def inplace_wrapper(pass_func: Callable) -> Callable:
    """
    Wrapper for a function that modifies an object in place and returns something other than the object.
    """
    @wraps(pass_func)
    def wrapper(*args, **kwargs):
        """
        Wrapper function to modify an object in place and return a modified object.
        """
        obj = args[0]  # Get the object to modify
        pass_func(obj, *args[1:], **kwargs)  # Apply the function on the object
